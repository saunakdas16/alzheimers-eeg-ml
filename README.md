...
**Pilot analysis in progress.**

The preprocessing and feature-extraction workflow is being validated on `sub-001` before scaling the pipeline to the complete 88-subject dataset.